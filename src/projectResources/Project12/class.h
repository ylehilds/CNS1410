...
// Post-conditions: none 
	Employee(int, int, string, string, string, string);
// virtual destructor
...
// getter
// Purpose: gets the employee type
// Parameters: none
...
// Pre-conditions: has to be in order
// Post-conditions: none 
	Salaried (int, int, string, string, string, string, double);
// destructor
...
// Pre-conditions: has to be in order
// Post-conditions: none 
	Sales (int, int, string, string, string, string, double, double);
// destructor
...
// Pre-conditions: has to be in order
// Post-conditions: none
	Hourly (int, int, string, string, string, string, double);
// destructor
